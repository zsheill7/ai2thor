...
RECEPTACLE_OBJECTS = {
    ...
    'Cabinet': {'Bowl',
                ...
                'Cup',
                'Fork',
                'Jar', # ShapeNet Category
                'KeyChain',
                'Knife',
                'Knife', # ShapeNet Category
                'Laptop',
                'Mug',
                'Newspaper',
                'Pan',
    ...
    'CounterTop': {'Apple',
                   'AppleSlice',
                   'Bottle', # ShapeNet Category
                   'Bowl', # ShapeNet Category
                   'Camera', # ShapeNet Category
                   'Can', # ShapeNet Category
                   'Cap', # ShapeNet Category
                   'Bowl',
                   'BowlDirty',
                   'BowlFilled',
                   'Box',
                   ...
                   'TomatoSliced',
                   'WateringCan',
                   'Guitar', # ShapeNet Category
                   'Keyboard', # ShapeNet Category
                   'Lamp', # ShapeNet Category
                   'Laptop', # ShapeNet Category
                   'Earphone', # ShapeNet Category
                   'Remote', # ShapeNet Category
                   'Telephone', # ShapeNet Category
                   'Phone'}, # ShapeNet Category},
    'Fridge': {'Apple',
               'AppleSlice',
               'Bottle', # ShapeNet Category
               'Bowl', # ShapeNet Category
